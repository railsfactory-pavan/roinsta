# -*- encoding: utf-8 -*-
# stub: api-pagination 4.8.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<railties>.freeze, [">= 5.0.0"])
    s.add_development_dependency(%q<actionpack>.freeze, [">= 5.0.0"])
    s.add_development_dependency(%q<sequel>.freeze, [">= 4.9.0"])
    s.add_development_dependency(%q<activerecord-nulldb-adapter>.freeze, [">= 0.3.9"])
  else
    ...
    s.add_dependency(%q<activerecord-nulldb-adapter>.freeze, [">= 0.3.9"])
  end
end
